...
//        5	Debug Message - The information string contains an internal debug message from the camera (not normally generated).
        ...
        disposable = (Disposable) cameraService.getImageChannel()
                .observeOn(AndroidSchedulers.mainThread())
                .toFlowable(BackpressureStrategy.DROP)
                .onErrorResumeNext(throwable -> {
                    cameraService.getImageChannel().subscribe(this::handleResponse);
    ...
    private void handleResponse(JSONObject obj) throws JSONException {
